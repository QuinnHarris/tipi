...
! function(a) {"use strict";
	...
	b.count = 0, b.VALID_NODES = ["P", "PRE", "BLOCKQUOTE", "H1", "H2", "H3", "H4", "H5", "H6", "DIV", "LI"], b.COLORS = ["#000000", "#444444", "#666666", "#999999", "#CCCCCC", "#EEEEEE", "#F3F3F3", "#FFFFFF", "#FF0000", "#FF9900", "#FFFF00", "#00FF00", "#00FFFF", "#0000FF", "#9900FF", "#FF00FF", "#F4CCCC", "#FCE5CD", "#FFF2CC", "#D9EAD3", "#D0E0E3", "#CFE2F3", "#D9D2E9", "#EAD1DC", "#EA9999", "#F9CB9C", "#FFE599", "#B6D7A8", "#A2C4C9", "#9FC5E8", "#B4A7D6", "#D5A6BD", "#E06666", "#F6B26B", "#FFD966", "#93C47D", "#76A5AF", "#6FA8DC", "#8E7CC3", "#C27BA0", "#CC0000", "#E69138", "#F1C232", "#6AA84F", "#45818E", "#3D85C6", "#674EA7", "#A64D79", "#990000", "#B45F06", "#BF9000", "#38771D", "#134F5C", "#0B5394", "#351C75", "#741B47", "#660000", "#783F04", "#7F6000", "#274E13", "#0C343D", "#073763", "#201211", "#4C1130"], b.image_commands = {
		...
		if (b.getIEversion() > 0)
			...
			var c = navigator.userAgent.toLowerCase(), d = /(chrome)[ \/]([\w.]+)/.exec(c) || /(webkit)[ \/]([\w.]+)/.exec(c) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(c) || /(msie) ([\w.]+)/.exec(c) || c.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(c) || [], e = {
				browser : d[1] || "",
				version : d[2] || "0"
			};
		...
		var a, b = null;
		return window.getSelection ? ( a = window.getSelection(), b = 1 !== a.anchorNode.nodeType ? a.anchorNode.parentNode.parentNode.href : a.anchorNode.parentNode.href) : ( a = document.selection) && "Control" != a.type && ( b = a.createRange().parentElement().href),
		void 0 === b ? null : b
		...
		return a.length && b.length ? (this.$element.removeAttr("contenteditable"), this.$element.focus(), this.setSelection(a[0], 0, b[0], 0), this.removeMarkers(), this.isImage || this.isHTML || this.$element.attr("contenteditable", !0),
		void  this.$element.focus()) : !1
		...
		if (this.browser.mozilla) {
			...
			var c = this.$element.find("#marker-true"), d = this.$element.find("#marker-false");
		...
		var b = this, c = a("<span>").addClass("f-img-handle").on({
		...
		var d = c.find("img").get(0), e = "Are you sure? Image will be deleted.";
		...
		if (window.getSelection) {
			...
			document.selection && "Control" != document.selection.type && ( b = document.selection.createRange(), c = b.duplicate(), c.moveToElementText(a), c.setEndPoint("EndToStart", b), d = "" === c.text, c.moveToElementText(a), c.setEndPoint("StartToEnd", b), e = "" === c.text);
		return {
			atStart : d,
			atEnd : e
		}
		...
		"TEXTAREA" == b.tagName ? (this.$textarea = a(b),
		void 0 !== this.$textarea.attr("placeholder") && "Type something" == this.options.placeholder && (this.options.placeholder = this.$textarea.attr("placeholder")), this.$element = a("<div>").html(this.$textarea.val()), this.$textarea.before(this.$element).hide(), this.$textarea.on("submit", a.proxy(function() {
			this.sync()
			...
			if (13 == c && "" === this.text() && d.indexOf(e.tagName) >= 0)
				if (this.getSelectionTextInfo(e).atEnd && !b.shiftKey) {
					...
					(this.browser.webkit || this.browser.msie) && (b.preventDefault(), this.insertHTML(this.endsWith(a(e).html(), "<br>") || !this.getSelectionTextInfo(e).atEnd ? "<br>" : "<br><br>"))
		...
		if (this.$element.find("img").each(function(b, d) {
			...
			void 0 === b)
			for (var d = 0; d < this.imageList.length; d++)
				c.indexOf(this.imageList[d]) < 0 && this.callback("afterRemoveImage", [this.imageList[d]], !1);
		this.imageList = c
		...
		var c = [], d = ["SPAN", "A", "B", "I", "EM", "U", "S", "STRONG", "STRIKE", "FONT"], e = this, f = function() {
			var b;
			if ( b = a(e.options.paragraphy === !0 ? "<p>" : "<div>"), 1 == c.length && ("marker-false" === a(c[0]).attr("id") || "marker-true" === a(c[0]).attr("id") || "" === a(c[0]).text()))
				return
				void ( c = []);
		...
		this.$element.contents().filter(function() {
			...
			for (var e = a(d).parent(); e.get(0) != this.$element.get(0); ) {
				if (b.VALID_NODES.indexOf(e.get(0).tagName) >= 0)
					return !0;
				e = e.parent()
			}
		...
		this.$element.get(0).onpaste = function() {
			if (!b.isHTML) {
				if (b.callback("beforePaste", [], !1) !== !0)
					return !1;
				b.pasting = !0, b.saveSelectionByMarkers();
				var c = a(window).scrollTop(), d = a('<div contenteditable="true"></div>').appendTo("body").focus();
		...
		var e = ["title", "href", "alt", "src", "style", "width", "height", "target", "rel", "name", "value", "type"], f = ["PRE", "BLOCKQUOTE"];
		c === !0 && (e.push("id"), e.push("class"));
		var g = this, h = a("<div>").html(b);
		...
		if (!this.isHTML && (this.$element.focus(), "" === this.text())) {
			...
			for (a in d)
			if ( c = d[a], !this.textEmpty(c))
				return
				void  this.setSelection(c, 0, null, 0);
		...
		a(window).on("hide." + this._id, a.proxy(function() {
			...
			if (this.imageMode) {
				...
				if (46 == b || 8 == b)
					return this.removeImage(this.$element.find(".f-img-editor")), !1
			}
		...
		for (var d in this.options.buttons) {
			...
			if (
				...
				if ( g = this.options.customButtons[this.options.buttons[d]],
				void 0 === g) {
					if ( g = this.options.customDropdowns[this.options.buttons[d]],
						void 0 === g)
						continue;
		...
		return
		void 0 !== this.options.icons[b.cmd] ? this.prepareIcon(c, this.options.icons[b.cmd]) : this.addButtonIcon(c, b), c
		...
		var c = a("<div>").addClass("fr-bttn fr-dropdown"), d = a("<button>").addClass("fr-trigger").attr("title", b.title);
		...
		for (var c in this.options.fontList) {
			var d = this.options.fontList[c], e = a("<li>").attr("data-cmd", "fontFamily").attr("data-val", d).append(a('<a href="#" data-text="true">').attr("title", d).css("font-family", d).text(d));
			b.append(e)
		}
		return b
		...
		a("<h4>").append('<span data-text="true">Manage images</span>').append(a('<i class="fa fa-times" title="Cancel">').click(a.proxy(function() {
			...
			c.stopPropagation();
			var d = a(c.currentTarget).prev(), e = "Are you sure? Image will be deleted.";
		...
		if (this.options.imageUpload) {
					...
					e.unbind("load"), e.bind("load", function() {
						try {
							if (c.options.imageUploadToS3) {
								var b = d.find("form").attr("action"), e = d.find('form input[name="key"]').val(), f = b + e;
			...
			this.$image_wrapper.on("change", 'input[type="file"]', function() {
				if (
					void 0 !== this.files)
					c.uploadFile(this.files), setTimeout(function() {
						c.showInsertImage()
					}, 500);
				else {
					...
					var d;
					for (d in c.options.imageUploadParams)
					b.prepend('<input type="hidden" name="' + d + '" value="' + c.options.imageUploadParams[d] + '" />');
					if (
					void 0 !== c.options.imageUploadToS3) {
						for (d in c.options.imageUploadToS3.params)
						b.prepend('<input type="hidden" name="' + d + '" value="' + c.options.imageUploadToS3.params[d] + '" />');
						...
						b.prepend('<input type="hidden" name="XHR_CORS_TRARGETORIGIN" value="' + window.location.href + '" />');
		...
		return d.onerror = a.proxy(function() {
			...
			var c = '<img alt="Image title" src="' + b + '" width="' + this.options.defaultImageWidth + '" style="min-width: 16px; min-height: 16px; margin-bottom: ' + this.options.imageMargin + "px; margin-left: auto; margin-right: auto; margin-top: " + this.options.imageMargin + 'px">', d = this.getSelectionElements()[0];
		...
		if (this.callback("beforeFileUpload", [b], !1) !== !0)
			return !1;
		if (
		void 0 !== b && b.length > 0) {
			var c;
			if (this.drag_support.formdata && ( c = this.drag_support.formdata ? new FormData : null), c) {
				...
				if (
				void 0 !== this.options.imageUploadToS3) {
		...
		var e = "", f = "";
		if (d === !0 && ( e = 'rel="nofollow"'), c === !0 && ( f = 'target="_blank"'), b = this.sanitizeURL(b), this.imageMode)
		...
		for (var c = 1; c <= b.count; c++)
			c != this._id && a(window).trigger("hide." + c)
		...
		this.$bttn_wrapper.find(".fr-dropdown").on("click touchend", function(c) {
			return c.stopPropagation(), c.preventDefault(), b.options.inlineMode === !1 && b.hide(), a(this).attr("data-disabled") ? !1 : (a(".fr-dropdown").not(this).removeClass("active"),
			void  a(this).toggleClass("active"))
		...
		b.on("touchmove", function() {
			...
			var c = b.currentTarget;
			if (a(c).data("dragging"))
				return a(c).removeData("dragging"), !1;
			var d = a(c).data("cmd"), e = a(c).data("val");
		...
		if (this.selectionInEditor()) {
			if ("" === this.text()) {
				if ("bold" === a || "italic" === a || "underline" === a || "strikeThrough" == a)
					return this._startInDefault(a), !1;
				if ("fontSize" == a)
					return this._startInFontExec("font-size", a, b), !1;
				if ("fontFamily" == a)
					return this._startInFontExec("font-family", a, b), !1
			}
			if ("" === this.text() && "insertHorizontalRule" != a && "fontSize" !== a && "formatBlock" !== a && "blockStyle" !== a && "indent" !== a && "outdent" !== a && "justifyLeft" !== a && "justifyRight" !== a && "justifyFull" !== a && "justifyCenter" !== a && "html" !== a && "undo" !== a && "redo" !== a && "selectAll" !== a && "save" !== a && "insertImage" !== a && "insertVideo" !== a && "insertOrderedList" !== a && "insertUnorderedList" !== a)
				return !1
		}
		switch(a) {
			case"fontSize":
		...
		return this.callback("beforeSave", [], !1) !== !0 ? !1 :
		void (this.options.saveURL ? a.post(this.options.saveURL, a.extend({
			body : this.getHTML()
		...
		for (var c = this.getSelectionElement(); a(c).get(0) != this.$element.get(0); ) {
			if (a(c).css("background-color") === b)
				return !0;
			if ("transparent" != a(c).css("background-color") && "rgba(0, 0, 0, 0)" != a(c).css("background-color"))
				return !1;
			c = a(c).parent()
		}
		return !1
		...
		for (var c = a(this.getSelectionElement()); c.get(0) != this.$element.get(0); ) {
			if (c.get(0).tagName == b.toUpperCase())
				return !0;
			c = c.parent()
		}
		return !1
		...
		try {
			if (document.queryCommandState(a) === !0)
				return !0
		} catch(b) {
		}
		return !1
		...
		if (
			void 0 === c && ( c = this.options.defaultBlockStyle),
			void 0 !== c)
			for (var d in c) {
				var e = c[d];
		...
		void (0 === this.$bttn_wrapper.find(".fr-block-style .active").length && this.$bttn_wrapper.find(".fr-block-style li:first").addClass("active")))
	...
	function c(c, d, e, f) {
		function g() {
			return this.pos = 0, this.token = "", this.current_mode = "CONTENT", this.tags = {
				...
				if (this.tags[a + "count"]) {
					...
					delete this.tags[a + this.tags[a + "count"]], 1 === this.tags[a + "count"] ?
					delete this.tags[a + "count"] : this.tags[a + "count"]--
				}
		...
		for ( d = d || {},
		void 0 !== d.wrap_line_length && 0 !== parseInt(d.wrap_line_length, 10) ||
		void 0 === d.max_char || 0 === parseInt(d.max_char, 10) || (d.wrap_line_length = d.max_char), i = d.indent_inner_html || !0, j = parseInt(d.indent_size || 1, 10), k = d.indent_char || "	", m = d.brace_style || "collapse", l = 0 === parseInt(d.wrap_line_length, 10) ? 32786 : parseInt(d.wrap_line_length || 1e5, 10), n = d.unformatted || ["a", "span", "bdo", "em", "strong", "dfn", "code", "samp", "kbd", "var", "cite", "abbr", "acronym", "q", "sub", "sup", "tt", "i", "b", "big", "small", "u", "s", "strike", "font", "ins", "del", "pre", "address", "dt", "h1", "h2", "h3", "h4", "h5", "h6"], o = d.preserve_newlines || !0, p = o ? parseInt(d.max_preserve_newlines || 32786, 10) : 0, q = d.indent_handlebars || !0, h = new g, h.printer(c, k, j, l, m); ; ) {
			var r = h.get_token();
